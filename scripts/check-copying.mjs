...
// tooling that made them (sources/_tools/) is gone, so a missing extraction has to
// be regenerated by hand for that one file; never bulk-regenerate existing ones.
//
